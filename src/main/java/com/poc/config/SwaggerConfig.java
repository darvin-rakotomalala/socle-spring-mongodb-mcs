...
public class SwaggerConfig {
    ...
    public Docket api() {
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .build()
                .apiInfo(apiInfo())
                .securitySchemes(Lists.newArrayList(apiKey())).securityContexts(Lists.newArrayList(securityContext())).apiInfo(apiInfo());
    ...
    private ApiInfo apiInfo() {
        return new ApiInfo(
                ...
                "Terms of service",
                new Contact("POC", "www.poc.com", "contact@poc.com"),
